    ...
    const templates = [
        {
            ...
            summarisedObject: JSON.stringify([
                ...
                },
                {
                    ...
                    content: {
                        description:
                            'Defines constants used within the todo contract, such as seeds and content length.',
                    },
                },
                {
                ...
                },
                {
                    ...
                    content: {
                        description:
                            'Defines custom error codes for the todo contract, including authorization and content validation.',
                    },
                },
                {
                ...
                },
                {
                    ...
                    content: {
                        description:
                            'Integration tests for the TodoContract program, covering creation, completion, and deletion of todos.',
                    },
                },
                {
                    id: '.gitignore',
                ...
                },
                {
                    ...
                    content: {
                        description:
                            'Specifies files and directories to be ignored by Prettier formatting.',
                    },
                },
                {
                    id: 'Anchor.toml',
