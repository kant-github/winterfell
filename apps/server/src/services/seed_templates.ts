...
export async function seedTemplates() {
    const templates: Prisma.TemplateCreateInput[] = [
        ...
        // template 2: vault contract
        {
            ...
            description: "A secure Anchor-based vault program supporting vault initialization, deposits, and withdrawals using PDA-managed accounts.",
            category: "defi",
            tags: [
                "vault",
                "anchor",
            ...
            summarisedObject: JSON.stringify([
                ...
                },
                {
                    ...
                    content: {
                        name: ".prettierignore",
                        description: "Specifies files and folders to ignore for Prettier formatting."
                    }
                },
                {
                    id: "migrations/deploy.ts",
                ...
                },
                {
                    ...
                    content: {
                        name: "Anchor.toml",
                        description: "Anchor workspace configuration, including program ID and provider settings."
                    }
                },
                {
                    id: "package.json",
