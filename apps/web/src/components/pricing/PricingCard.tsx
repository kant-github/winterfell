...
export default function PricingCard({
    ...
    return (
        <div className="w-110 h-full min-h-140 rounded-lg select-none border tracking-wide shadow-sm hover:shadow-md hover:border-primary/40 transition-colors duration-200 border-neutral-800 bg-linear-to-br from-dark via-darkest to-dark p-8 flex flex-col gap-y-7">
