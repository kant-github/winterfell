export default function PricingHeader() {
    return (
        <div className="mt-14 tracking-wider flex flex-col items-center w-full max-w-[70%] gap-y-4 select-none">
            ...
            <div className="flex flex-col gap-y-4 items-center">
                <div className="text-7xl font-semibold leading-[55px] pt-4 text-transparent bg-clip-text bg-linear-to-t from-light/30 via-light/70 to-light tracking-wide">
                    Winterfell Plans
                </div>
